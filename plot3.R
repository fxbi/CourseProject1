...
xLabel = ""
mainLabel = ""
measures <- cbind(cbind(ds$Sub_metering_1, ds$Sub_metering_2), ds$Sub_metering_3)
...
plot(dimension, measures[,1], col = colours[1], type = "l", main = mainLabel, ylab = yLabel, xlab = xLabel)
lines(dimension, measures[,2], col = colours[2], type = "l")
lines(dimension, measures[,3], col = colours[3], type = "l")
legend("topright", legends, lty=1, lwd=2.5, col=c("black", "red", "blue"))
dev.off()